    ...
    <>
      ...
      <div name="home" className='h-[100svh] lg:h-screen w-full bg-gray-800 flex items-center justify-center px-[2rem] md:px-[6rem] 2xl:px-[10rem] '>
          <div className="flex flex-col gap-4 z-10">
              ...
              <span className='text-gray-400 text-[0.7rem] md:text-md lg:text-[0.95rem] 2xl:text-xl text-center max-w-[15rem] md:max-w-full'>"I bring design to life with clean and efficient code."</span>
